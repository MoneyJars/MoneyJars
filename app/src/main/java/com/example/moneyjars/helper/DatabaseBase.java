...
/****************************************************** TEST DATA FOR REPORT START********************************/
        ...
        queries.add("insert into financial values(1, 'DayExpense1', 1000, '2021/03/24', '01', 'test1@hotmail.com', '10016')");
        queries.add("insert into financial values(2, 'DayExpense1', 2000, '2021/03/24', '01', 'test1@hotmail.com', '10017')");
        queries.add("insert into financial values(3, 'MonthlyExpense', 3000, '2021/03/25', '02', 'test1@hotmail.com', '10018')");
        queries.add("insert into financial values(4, 'MonthlyExpense', 4000, '2021/03/28', '02', 'test1@hotmail.com', '10019')");
        queries.add("insert into expense values(1, 'DayExpense1')");
        queries.add("insert into expense values(2, 'DayExpense1')");
        queries.add("insert into expense values(3, 'DayExpense1')");
        queries.add("insert into expense values(4, 'DayExpense1')");
